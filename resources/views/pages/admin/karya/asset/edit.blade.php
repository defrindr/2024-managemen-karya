            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form id="form" method="POST"
                        action="{{ route('admin.master.karya.asset.update', compact('karya', 'redirect', 'asset')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="tipe" id="input__tipe" class="form-control">
                                ...
                                <option @if ($asset->tipe == 'poster') selected @endif value="poster">Poster</option>
                                <option @if ($asset->tipe == 'kegiatan') selected @endif value="kegiatan">Kegiatan</option>
                                <option @if ($asset->tipe == 'peserta') selected @endif value="peserta">Peserta</option>
                            </select>
                            @error('tipe')
